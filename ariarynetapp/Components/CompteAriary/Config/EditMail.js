...
class EditMail extends Component {
	...
	_renderPasswordView() {
		if (!this._isEmptyField()) {
			...
			Alert.alert('Info', "Il semble qu'aucune information n'est saisie. Voulez-vous annuler le changement?", [
				{ text: 'Editer' },
						...
						<View style={{ width: '80%', backgroundColor: 'white', borderRadius: 10 }}>
							...
							>
								<Text style={{ textAlign: 'center', paddingHorizontal: 20 }}>
									Entrer votre mot de passe poour confirmer le changement de votre mail
								</Text>
							</View>
